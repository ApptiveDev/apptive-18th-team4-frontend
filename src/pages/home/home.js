...
export default function Home() {
  ...
  useEffect(() => {
    const drawMap = () => {
      ...
      // 마커가 표시될 위치
      let markerPosition = new kakao.maps.LatLng(lat, lang);
  ...
  }, [lat, lang]); // 의존성 배열에 lat, lang 상태 포함
              ...
              <div style={{ display: "flex", alignItems: "flex-end" }}>
                <a href="#s1">
                  <div className="shortcutBtn">
                    <img src="/assets/img/home_icon1.png" />빈 강의실 찾기
                  </div>
                </a>
                <a href="#s2">
                  <div className="shortcutBtn">
      ...
      <div style={{ background: "#f3f3f3" }}>
        <div id="s1" className="section1">
          <div className="section1_top">
            ...
            >
              <img
                src="/assets/img/home_icon1_black.png"
            ...
            >
              <span
                onClick={() => setSelect("거리순")}
                style={{
                  color: select === "거리순" ? "black" : "#A4A4A4",
                  marginRight: "2.69rem",
                }}
              >
                거리순
        ...
        <div id="s2" className="section2" style={{ padding: "1.25rem 14%" }}>
          <WeeklyCalendar />
        </div>

        <div id="s3" className="section3" style={{ padding: "0 14% 5% 14%" }}>
          <div className="section3-box">
            <div className="section3_top">
              <img
                src="/assets/img/bell_black.png"
                style={{
                  marginRight: "2.6rem",
                }}
              />
